...
### 規模
題庫 512 題（官方 358＋翰林 108＋自編 46）｜選擇模板 29 張｜非選模板 12 張｜配圖元件 17 種｜
評分規準 40 題（官方 26＋翰林 8＋自編 6）｜觀念補強 56 單元 336 題｜Python 腳本頂層 39 支（另有 vendor）
翰林卷：HL1（110年）、HL2（111年）、HL112（112年）、HL113（113年）各 27 題
